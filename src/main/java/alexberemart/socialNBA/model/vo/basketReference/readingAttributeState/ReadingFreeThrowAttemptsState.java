...
public class ReadingFreeThrowAttemptsState extends ReadingAttributeState{
    @Override
    public void gotToNextState(PlayerStats playerStats, String attributeValue) {
        playerStats.setFreeThrowAttempts(attributeValue);
        playerStats.setState(new ReadingFreeThrowPercentageState());
    }
}
